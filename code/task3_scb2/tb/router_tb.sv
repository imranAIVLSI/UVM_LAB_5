class router_tb extends uvm_env;
    ...
    function void connect_phase(uvm_phase phase);
        ...
        chan0.rx_agent.monitor.item_collected_port.connect(rt_env.rt_scb.channel0_in);
        chan1.rx_agent.monitor.item_collected_port.connect(rt_env.rt_scb.channel1_in);
        chan2.rx_agent.monitor.item_collected_port.connect(rt_env.rt_scb.channel2_in);

        YAPP.agent.monitor.yapp_out.connect(rt_env.rt_reference.yapp_in);
        hbus.masters[0].monitor.item_collected_port.connect(rt_env.rt_reference.hbuss_in);
    endfunction
